...
plt.title(f'Comparison between CNN-LSTM-Attention predicted/real values on the train')
plt.legend()
...
plt.title(f'Comparison between CNN-LSTM-Attention predicted/real values on the test')
plt.legend()
