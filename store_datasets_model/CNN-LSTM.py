...
plt.title(f'Comparison between CNN-LSTM predicted/real values on the train for the store 1')
plt.legend()
...
plt.title(f'Comparison between CNN-LSTM predicted/real values on the test for the store 1')
plt.legend()
